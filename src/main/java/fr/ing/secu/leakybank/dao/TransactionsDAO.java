...
public class TransactionsDAO {
    ...
    public List<Transaction> findTransactionsByAccountNumber(int accountNumber) {
        ...
        return jdbcTemplate.query(sqlQuery, preparedStatement -> preparedStatement.setInt(1, accountNumber),
    ...
    public void processMoneyTransfer(int debitAccountNumber, int creditAccountNumber, BigDecimal amount, String description) {
        ...
        final String insertTransactionDebitAccSQL = "INSERT INTO INTERNAL_ACCOUNT_TRANSACTIONS(ACCOUNT_NUMBER, AMOUNT, DESCRIPTION, OPERATION_DATE) values(? , ? , 'DEBIT - ?', CURDATE())";
        ...
        final String insertTransactionCreditAccSQL = "INSERT INTO INTERNAL_ACCOUNT_TRANSACTIONS(ACCOUNT_NUMBER, AMOUNT, DESCRIPTION, OPERATION_DATE) values(? , ? , 'CREDIT - ?', CURDATE())";
